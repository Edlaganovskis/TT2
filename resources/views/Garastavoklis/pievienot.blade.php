...
<body>
    ...
    <div class="container">
        <h2>Pievienot garastāvokli</h2>
        <form method="POST" action="{{ route('Garastavoklis.Registrs') }}">
            @csrf
            ...
            <div>
                ...
                <select name="Gstavoklis" required>
                    <option value="">Izvēlies garastāvokli</option>
            ...
            <div>
                ...
                <select name="sajutas" id="sajutas-select" required>
                    <option value="">Izvēlies savas jūtas</option>
